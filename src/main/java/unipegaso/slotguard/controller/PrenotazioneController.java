...
import unipegaso.slotguard.component.SecurityUtils;
...
public class PrenotazioneController {
    ...
    public ResponseEntity<PrenotazioneDTORes> createPrenotazione(@RequestBody PrenotazioneDTOReq req) throws Exception {
        req.setMatricolaOperatore(securityUtils.getMatricola());
    ...
    public ResponseEntity<PrenotazioneDTORes> modificaPrenotazione(@RequestBody UpdatePrenotazioneDTOReq req) throws Exception {
        req.setMatricolaOperatore(securityUtils.getMatricola());
